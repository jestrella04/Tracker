 ...
 * @license MIT
 */
!function($){var jversion=$.fn.jquery.split("."),jmajor=parseFloat(jversion[0]),jminor=parseFloat(jversion[1]);jmajor<2&&jminor<8?($.expr[":"].filterTableFind=function(a,i,m){return $(a).text().toUpperCase().indexOf(m[3].toUpperCase().replace(/"""/g,'"').replace(/"\\"/g,"\\"))>=0},$.expr[":"].filterTableFindAny=function(a,i,m){var raw_args=m[3].split(/[\s,]/),args=[];return $.each(raw_args,function(j,v){var t=v.replace(/^\s+|\s$/g,"");t&&args.push(t)}),!!args.length&&function(a){var found=!1;return $.each(args,function(j,v){if($(a).text().toUpperCase().indexOf(v.toUpperCase().replace(/"""/g,'"').replace(/"\\"/g,"\\"))>=0)return found=!0,!1}),found}},$.expr[":"].filterTableFindAll=function(a,i,m){var raw_args=m[3].split(/[\s,]/),args=[];return $.each(raw_args,function(j,v){var t=v.replace(/^\s+|\s$/g,"");t&&args.push(t)}),!!args.length&&function(a){var found=0;return $.each(args,function(j,v){$(a).text().toUpperCase().indexOf(v.toUpperCase().replace(/"""/g,'"').replace(/"\\"/g,"\\"))>=0&&found++}),found===args.length}}):($.expr[":"].filterTableFind=jQuery.expr.createPseudo(function(arg){return function(el){return $(el).text().toUpperCase().indexOf(arg.toUpperCase().replace(/"""/g,'"').replace(/"\\"/g,"\\"))>=0}}),$.expr[":"].filterTableFindAny=jQuery.expr.createPseudo(function(arg){var raw_args=arg.split(/[\s,]/),args=[];return $.each(raw_args,function(i,v){var t=v.replace(/^\s+|\s$/g,"");t&&args.push(t)}),!!args.length&&function(el){var found=!1;return $.each(args,function(i,v){if($(el).text().toUpperCase().indexOf(v.toUpperCase().replace(/"""/g,'"').replace(/"\\"/g,"\\"))>=0)return found=!0,!1}),found}}),$.expr[":"].filterTableFindAll=jQuery.expr.createPseudo(function(arg){var raw_args=arg.split(/[\s,]/),args=[];return $.each(raw_args,function(i,v){var t=v.replace(/^\s+|\s$/g,"");t&&args.push(t)}),!!args.length&&function(el){var found=0;return $.each(args,function(i,v){$(el).text().toUpperCase().indexOf(v.toUpperCase().replace(/"""/g,'"').replace(/"\\"/g,"\\"))>=0&&found++}),found===args.length}})),$.fn.filterTable=function(options){var defaults={autofocus:!1,callback:null,containerClass:"filter-table",containerTag:"p",filterExpression:"filterTableFind",hideTFootOnFilter:!1,highlightClass:"alt",ignoreClass:"",ignoreColumns:[],inputSelector:null,inputName:"",inputType:"search",label:"Filter:",minChars:1,minRows:8,placeholder:"search this table",preventReturnKey:!0,quickList:[],quickListClass:"quick",quickListClear:"",quickListGroupTag:"",quickListTag:"a",visibleClass:"visible"},hsc=function(text){return text.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},settings=$.extend({},defaults,options),doFiltering=function(table,q){var tbody=table.find("tbody");if(""===q||q.length<settings.minChars)tbody.find("tr").show().addClass(settings.visibleClass),tbody.find("td").removeClass(settings.highlightClass),settings.hideTFootOnFilter&&table.find("tfoot").show();else{var all_tds=tbody.find("td");if(tbody.find("tr").hide().removeClass(settings.visibleClass),all_tds.removeClass(settings.highlightClass),settings.hideTFootOnFilter&&table.find("tfoot").hide(),settings.ignoreColumns.length){var tds=[];settings.ignoreClass&&(all_tds=all_tds.not("."+settings.ignoreClass)),tds=all_tds.filter(":"+settings.filterExpression+'("'+q+'")'),tds.each(function(){var t=$(this),col=t.parent().children().index(t);-1===$.inArray(col,settings.ignoreColumns)&&t.addClass(settings.highlightClass).closest("tr").show().addClass(settings.visibleClass)})}else settings.ignoreClass&&(all_tds=all_tds.not("."+settings.ignoreClass)),all_tds.filter(":"+settings.filterExpression+'("'+q+'")').addClass(settings.highlightClass).closest("tr").show().addClass(settings.visibleClass)}settings.callback&&settings.callback(q,table)};return this.each(function(){var t=$(this),tbody=t.find("tbody"),container=null,quicks=null,filter=null,created_filter=!0;if("TABLE"===t[0].nodeName&&tbody.length>0&&(0===settings.minRows||settings.minRows>0&&tbody.find("tr").length>=settings.minRows)&&!t.prev().hasClass(settings.containerClass)){if(settings.inputSelector&&1===$(settings.inputSelector).length?(filter=$(settings.inputSelector),container=filter.parent(),created_filter=!1):(container=$("<"+settings.containerTag+" />"),""!==settings.containerClass&&container.addClass(settings.containerClass),container.prepend(settings.label+" "),filter=$('<input type="'+settings.inputType+'" placeholder="'+settings.placeholder+'" name="'+settings.inputName+'" />'),settings.preventReturnKey&&filter.on("keydown",function(ev){if(13===(ev.keyCode||ev.which))return ev.preventDefault(),!1})),settings.autofocus&&filter.attr("autofocus",!0),$.fn.bindWithDelay?filter.bindWithDelay("keyup",function(){doFiltering(t,$(this).val())},200):filter.bind("keyup",function(){doFiltering(t,$(this).val())}),filter.bind("click search input paste blur",function(){doFiltering(t,$(this).val())}),created_filter&&container.append(filter),settings.quickList.length>0||settings.quickListClear){if(quicks=settings.quickListGroupTag?$("<"+settings.quickListGroupTag+" />"):container,$.each(settings.quickList,function(index,value){var q=$("<"+settings.quickListTag+' class="'+settings.quickListClass+'" />');q.text(hsc(value)),"A"===q[0].nodeName&&q.attr("href","#"),q.bind("click",function(e){e.preventDefault(),filter.val(value).focus().trigger("click")}),quicks.append(q)}),settings.quickListClear){var q=$("<"+settings.quickListTag+' class="'+settings.quickListClass+'" />');q.html(settings.quickListClear),"A"===q[0].nodeName&&q.attr("href","#"),q.bind("click",function(e){e.preventDefault(),filter.val("").focus().trigger("click")}),quicks.append(q)}quicks!==container&&container.append(quicks)}created_filter&&t.before(container)}})}}(jQuery)}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function(jQuery){!function($,window,document,undefined){function Plugin(element,options){this.element=element,this.settings=$.extend({},defaults,options),this._defaults=defaults,this._name=pluginName,this.init()}function getFileName(settings){return settings.filename?settings.filename:"table2excel"}function exclude_img(string){var _patt=/(\s+alt\s*=\s*"([^"]*)"|\s+alt\s*=\s*'([^']*)')/i;return string.replace(/<img[^>]*>/gi,function(x){var res=_patt.exec(x);return null!==res&&res.length>=2?res[2]:""})}function exclude_links(string){return string.replace(/<a[^>]*>|<\/a>/gi,"")}function exclude_inputs(string){var _patt=/(\s+value\s*=\s*"([^"]*)"|\s+value\s*=\s*'([^']*)')/i;return string.replace(/<input[^>]*>|<\/input>/gi,function(x){var res=_patt.exec(x);return null!==res&&res.length>=2?res[2]:""})}var pluginName="table2excel",defaults={exclude:".noExl",name:"Table2Excel",filename:"table2excel",fileext:".xls",exclude_img:!0,exclude_links:!0,exclude_inputs:!0};Plugin.prototype={init:function(){var e=this;e.template={head:'<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="http://www.w3.org/TR/REC-html40"><meta http-equiv="content-type" content="application/vnd.ms-excel; charset=UTF-8"><head>\x3c!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets>',sheet:{head:"<x:ExcelWorksheet><x:Name>",tail:"</x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet>"},mid:"</x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--\x3e</head><body>",table:{head:"<table>",tail:"</table>"},foot:"</body></html>"},e.tableRows=[],$(e.element).each(function(i,o){var tempRows="";$(o).find("tr").not(e.settings.exclude).each(function(i,p){tempRows+="<tr>",$(p).find("td,th").not(e.settings.exclude).each(function(i,q){var rc={rows:$(this).attr("rowspan"),cols:$(this).attr("colspan"),flag:$(q).find(e.settings.exclude)};rc.flag.length>0?tempRows+="<td> </td>":rc.rows&rc.cols?tempRows+="<td>"+$(q).html()+"</td>":(tempRows+="<td",rc.rows>0&&(tempRows+=" rowspan='"+rc.rows+"' "),rc.cols>0&&(tempRows+=" colspan='"+rc.cols+"' "),tempRows+="/>"+$(q).html()+"</td>")}),tempRows+="</tr>",console.log(tempRows)}),e.settings.exclude_img&&(tempRows=exclude_img(tempRows)),e.settings.exclude_links&&(tempRows=exclude_links(tempRows)),e.settings.exclude_inputs&&(tempRows=exclude_inputs(tempRows)),e.tableRows.push(tempRows)}),e.tableToExcel(e.tableRows,e.settings.name,e.settings.sheetName)},tableToExcel:function(table,name,sheetName){var i,link,a,e=this,fullTemplate="";if(e.format=function(s,c){return s.replace(/{(\w+)}/g,function(m,p){return c[p]})},sheetName=void 0===sheetName?"Sheet":sheetName,e.ctx={worksheet:name||"Worksheet",table:table,sheetName:sheetName},fullTemplate=e.template.head,$.isArray(table))for(i in table)fullTemplate+=e.template.sheet.head+sheetName+i+e.template.sheet.tail;if(fullTemplate+=e.template.mid,$.isArray(table))for(i in table)fullTemplate+=e.template.table.head+"{table"+i+"}"+e.template.table.tail;fullTemplate+=e.template.foot;for(i in table)e.ctx["table"+i]=table[i];if(delete e.ctx.table,!document.documentMode){var blob=new Blob([e.format(fullTemplate,e.ctx)],{type:"application/vnd.ms-excel"});window.URL=window.URL||window.webkitURL,link=window.URL.createObjectURL(blob),a=document.createElement("a"),a.download=getFileName(e.settings),a.href=link,document.body.appendChild(a),a.click(),document.body.removeChild(a)}else if("undefined"!=typeof Blob){fullTemplate=e.format(fullTemplate,e.ctx),fullTemplate=[fullTemplate];var blob1=new Blob(fullTemplate,{type:"text/html"});window.navigator.msSaveBlob(blob1,getFileName(e.settings))}else txtArea1.document.open("text/html","replace"),txtArea1.document.write(e.format(fullTemplate,e.ctx)),txtArea1.document.close(),txtArea1.focus(),sa=txtArea1.document.execCommand("SaveAs",!0,getFileName(e.settings));return!0}},$.fn[pluginName]=function(options){var e=this;return e.each(function(){$.data(e,"plugin_"+pluginName)||$.data(e,"plugin_"+pluginName,new Plugin(this,options))}),e}}(jQuery,window,document)}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function(jQuery){!function($){function appendContent($el,content){content&&$el.append(content.jquery?content.clone():content)}function appendBody($body,$element,opt){var $content=$element.clone(opt.formValues);opt.formValues&&copyValues($element,$content,"select, textarea"),opt.removeScripts&&$content.find("script").remove(),opt.printContainer?$content.appendTo($body):$content.each(function(){$(this).children().appendTo($body)})}function copyValues(origin,clone,elementSelector){var $originalElements=origin.find(elementSelector);clone.find(elementSelector).each(function(index,item){$(item).val($originalElements.eq(index).val())})}var opt;$.fn.printThis=function(options){opt=$.extend({},$.fn.printThis.defaults,options);var $element=this instanceof jQuery?this:$(this),strFrameName="printThis-"+(new Date).getTime();if(window.location.hostname!==document.domain&&navigator.userAgent.match(/msie/i)){var iframeSrc='javascript:document.write("<head><script>document.domain=\\"'+document.domain+'\\";<\/script></head><body></body>")',printI=document.createElement("iframe");printI.name="printIframe",printI.id=strFrameName,printI.className="MSIE",document.body.appendChild(printI),printI.src=iframeSrc}else{$("<iframe id='"+strFrameName+"' name='printIframe' />").appendTo("body")}var $iframe=$("#"+strFrameName);opt.debug||$iframe.css({position:"absolute",width:"0px",height:"0px",left:"-600px",top:"-600px"}),setTimeout(function(){opt.doctypeString&&function($iframe,doctype){var win,doc;win=$iframe.get(0),win=win.contentWindow||win.contentDocument||win,doc=win.document||win.contentDocument||win,doc.open(),doc.write(doctype),doc.close()}($iframe,opt.doctypeString);var baseURL,$doc=$iframe.contents(),$head=$doc.find("head"),$body=$doc.find("body"),$base=$("base");baseURL=!0===opt.base&&$base.length>0?$base.attr("href"):"string"==typeof opt.base?opt.base:document.location.protocol+"//"+document.location.host,$head.append('<base href="'+baseURL+'">'),opt.importCSS&&$("link[rel=stylesheet]").each(function(){var href=$(this).attr("href");if(href){var media=$(this).attr("media")||"all";$head.append("<link type='text/css' rel='stylesheet' href='"+href+"' media='"+media+"'>")}}),opt.importStyle&&$("style").each(function(){$head.append(this.outerHTML)}),opt.pageTitle&&$head.append("<title>"+opt.pageTitle+"</title>"),opt.loadCSS&&($.isArray(opt.loadCSS)?jQuery.each(opt.loadCSS,function(index,value){$head.append("<link type='text/css' rel='stylesheet' href='"+this+"'>")}):$head.append("<link type='text/css' rel='stylesheet' href='"+opt.loadCSS+"'>"));var tag=opt.copyTagClasses;if(tag&&(tag=!0===tag?"bh":tag,-1!==tag.indexOf("b")&&$body.addClass($("body")[0].className),-1!==tag.indexOf("h")&&$doc.find("html").addClass($("html")[0].className)),appendContent($body,opt.header),opt.canvas){var canvasId=0;$element.find("canvas").addBack("canvas").each(function(){$(this).attr("data-printthis",canvasId++)})}appendBody($body,$element,opt),opt.canvas&&$body.find("canvas").each(function(){var cid=$(this).data("printthis"),$src=$('[data-printthis="'+cid+'"]');this.getContext("2d").drawImage($src[0],0,0),$src.removeData("printthis")}),opt.removeInline&&($.isFunction($.removeAttr)?$doc.find("body *").removeAttr("style"):$doc.find("body *").attr("style","")),appendContent($body,opt.footer),setTimeout(function(){$iframe.hasClass("MSIE")?(window.frames.printIframe.focus(),$head.append("<script>  window.print(); <\/script>")):document.queryCommandSupported("print")?$iframe[0].contentWindow.document.execCommand("print",!1,null):($iframe[0].contentWindow.focus(),$iframe[0].contentWindow.print()),opt.debug||setTimeout(function(){$iframe.remove()},1e3)},opt.printDelay)},333)},$.fn.printThis.defaults={debug:!1,importCSS:!0,importStyle:!1,printContainer:!0,loadCSS:"",pageTitle:"",removeInline:!1,printDelay:333,header:null,footer:null,formValues:!0,canvas:!1,base:!1,doctypeString:"<!DOCTYPE html>",removeScripts:!1,copyTagClasses:!1}}(jQuery)}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){(function(jQuery){!function($,window,undefined){"use strict";function Plugin(el,options){var base=this;base.$el=$(el),base.el=el,base.id=id++,base.$el.bind("destroyed",$.proxy(base.teardown,base)),base.$clonedHeader=null,base.$originalHeader=null,base.cachedHeaderHeight=null,base.isSticky=!1,base.hasBeenSticky=!1,base.leftOffset=null,base.topOffset=null,base.init=function(){base.setOptions(options),base.$el.each(function(){var $this=$(this);$this.css("padding",0),base.$originalHeader=$("thead:first",this),base.$clonedHeader=base.$originalHeader.clone(),$this.trigger("clonedHeader."+name,[base.$clonedHeader]),base.$clonedHeader.addClass("tableFloatingHeader"),base.$clonedHeader.css({display:"none",opacity:0}),base.$originalHeader.addClass("tableFloatingHeaderOriginal"),base.$originalHeader.after(base.$clonedHeader),base.$printStyle=$('<style type="text/css" media="print">.tableFloatingHeader{display:none !important;}.tableFloatingHeaderOriginal{position:static !important;}</style>'),base.$head.append(base.$printStyle)}),base.$clonedHeader.find("input, select").attr("disabled",!0),base.updateWidth(),base.toggleHeaders(),base.bind()},base.destroy=function(){base.$el.unbind("destroyed",base.teardown),base.teardown()},base.teardown=function(){base.isSticky&&base.$originalHeader.css("position","static"),$.removeData(base.el,"plugin_"+name),base.unbind(),base.$clonedHeader.remove(),base.$originalHeader.removeClass("tableFloatingHeaderOriginal"),base.$originalHeader.css("visibility","visible"),base.$printStyle.remove(),base.el=null,base.$el=null},base.bind=function(){base.$scrollableArea.on("scroll."+name,base.toggleHeaders),base.isWindowScrolling||(base.$window.on("scroll."+name+base.id,base.setPositionValues),base.$window.on("resize."+name+base.id,base.toggleHeaders)),base.$scrollableArea.on("resize."+name,base.toggleHeaders),base.$scrollableArea.on("resize."+name,base.updateWidth)},base.unbind=function(){base.$scrollableArea.off("."+name,base.toggleHeaders),base.isWindowScrolling||(base.$window.off("."+name+base.id,base.setPositionValues),base.$window.off("."+name+base.id,base.toggleHeaders)),base.$scrollableArea.off("."+name,base.updateWidth)},base.debounce=function(fn,delay){var timer=null;return function(){var context=this,args=arguments;clearTimeout(timer),timer=setTimeout(function(){fn.apply(context,args)},delay)}},base.toggleHeaders=base.debounce(function(){base.$el&&base.$el.each(function(){var newLeft,headerHeight,notScrolledPastBottom,$this=$(this),newTopOffset=base.isWindowScrolling?isNaN(base.options.fixedOffset)?base.options.fixedOffset.outerHeight():base.options.fixedOffset:base.$scrollableArea.offset().top+(isNaN(base.options.fixedOffset)?0:base.options.fixedOffset),offset=$this.offset(),scrollTop=base.$scrollableArea.scrollTop()+newTopOffset,scrollLeft=base.$scrollableArea.scrollLeft(),scrolledPastTop=base.isWindowScrolling?scrollTop>offset.top:newTopOffset>offset.top;scrolledPastTop&&(headerHeight=base.options.cacheHeaderHeight?base.cachedHeaderHeight:base.$clonedHeader.height(),notScrolledPastBottom=(base.isWindowScrolling?scrollTop:0)<offset.top+$this.height()-headerHeight-(base.isWindowScrolling?0:newTopOffset)),scrolledPastTop&&notScrolledPastBottom?(newLeft=offset.left-scrollLeft+base.options.leftOffset,base.$originalHeader.css({position:"fixed","margin-top":base.options.marginTop,top:0,left:newLeft,"z-index":base.options.zIndex}),base.leftOffset=newLeft,base.topOffset=newTopOffset,base.$clonedHeader.css("display",""),base.isSticky||(base.isSticky=!0,base.updateWidth(),$this.trigger("enabledStickiness."+name)),base.setPositionValues()):base.isSticky&&(base.$originalHeader.css("position","static"),base.$clonedHeader.css("display","none"),base.isSticky=!1,base.resetWidth($("td,th",base.$clonedHeader),$("td,th",base.$originalHeader)),$this.trigger("disabledStickiness."+name))})},0),base.setPositionValues=base.debounce(function(){var winScrollTop=base.$window.scrollTop(),winScrollLeft=base.$window.scrollLeft();!base.isSticky||winScrollTop<0||winScrollTop+base.$window.height()>base.$document.height()||winScrollLeft<0||winScrollLeft+base.$window.width()>base.$document.width()||base.$originalHeader.css({top:base.topOffset-(base.isWindowScrolling?0:winScrollTop),left:base.leftOffset-(base.isWindowScrolling?0:winScrollLeft)})},0),base.updateWidth=base.debounce(function(){if(base.isSticky){base.$originalHeaderCells||(base.$originalHeaderCells=$("th,td",base.$originalHeader)),base.$clonedHeaderCells||(base.$clonedHeaderCells=$("th,td",base.$clonedHeader));var cellWidths=base.getWidth(base.$clonedHeaderCells);base.setWidth(cellWidths,base.$clonedHeaderCells,base.$originalHeaderCells),base.$originalHeader.css("width",base.$clonedHeader.width()),base.options.cacheHeaderHeight&&(base.cachedHeaderHeight=base.$clonedHeader.height())}},0),base.getWidth=function($clonedHeaders){var widths=[];return $clonedHeaders.each(function(index){var width,$this=$(this);if("border-box"===$this.css("box-sizing")){var boundingClientRect=$this[0].getBoundingClientRect();width=boundingClientRect.width?boundingClientRect.width:boundingClientRect.right-boundingClientRect.left}else{if("collapse"===$("th",base.$originalHeader).css("border-collapse"))if(window.getComputedStyle)width=parseFloat(window.getComputedStyle(this,null).width);else{var leftPadding=parseFloat($this.css("padding-left")),rightPadding=parseFloat($this.css("padding-right")),border=parseFloat($this.css("border-width"));width=$this.outerWidth()-leftPadding-rightPadding-border}else width=$this.width()}widths[index]=width}),widths},base.setWidth=function(widths,$clonedHeaders,$origHeaders){$clonedHeaders.each(function(index){var width=widths[index];$origHeaders.eq(index).css({"min-width":width,"max-width":width})})},base.resetWidth=function($clonedHeaders,$origHeaders){$clonedHeaders.each(function(index){var $this=$(this);$origHeaders.eq(index).css({"min-width":$this.css("min-width"),"max-width":$this.css("max-width")})})},base.setOptions=function(options){base.options=$.extend({},defaults,options),base.$window=$(base.options.objWindow),base.$head=$(base.options.objHead),base.$document=$(base.options.objDocument),base.$scrollableArea=$(base.options.scrollableArea),base.isWindowScrolling=base.$scrollableArea[0]===base.$window[0]},base.updateOptions=function(options){base.setOptions(options),base.unbind(),base.bind(),base.updateWidth(),base.toggleHeaders()},base.init()}var name="stickyTableHeaders",id=0,defaults={fixedOffset:0,leftOffset:0,marginTop:0,objDocument:document,objHead:"head",objWindow:window,scrollableArea:window,cacheHeaderHeight:!1,zIndex:3};$.fn[name]=function(options){return this.each(function(){var instance=$.data(this,"plugin_"+name);instance?"string"==typeof options?instance[options].apply(instance):instance.updateOptions(options):"destroy"!==options&&$.data(this,"plugin_"+name,new Plugin(this,options))})}}(jQuery,window)}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_FACTORY__,__WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;!function(factory){__WEBPACK_AMD_DEFINE_ARRAY__=[__webpack_require__(1)],__WEBPACK_AMD_DEFINE_FACTORY__=factory,void 0!==(__WEBPACK_AMD_DEFINE_RESULT__="function"==typeof __WEBPACK_AMD_DEFINE_FACTORY__?__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__):__WEBPACK_AMD_DEFINE_FACTORY__)&&(module.exports=__WEBPACK_AMD_DEFINE_RESULT__)}(function($,undefined){"use strict";function Show(container,settings){container=$(container),settings.size=_ParseSize(settings.size),settings.maxSize=parseInt(settings.maxSize,10)||0,settings.minSize=parseInt(settings.minSize,10)||0,settings.resizeInterval=parseInt(settings.resizeInterval,10)||0;var overlay=container.data("loadingoverlay"),data=_GetData(overlay);if(!1===data){if(data=$.extend({},_dataTemplate),data.container=container,data.wholePage=container.is("body"),overlay=$("<div>",{class:"loadingoverlay"}).css(_css.overlay).css("flex-direction","row"===settings.direction.toLowerCase()?"row":"column"),settings.backgroundClass?overlay.addClass(settings.backgroundClass):overlay.css("background",settings.background),data.wholePage&&overlay.css({position:"fixed",top:0,left:0,width:"100%",height:"100%"}),void 0!==settings.zIndex&&overlay.css("z-index",settings.zIndex),settings.image){$.isArray(settings.imageColor)?0===settings.imageColor.length?settings.imageColor=!1:1===settings.imageColor.length?settings.imageColor={fill:settings.imageColor[0]}:settings.imageColor={fill:settings.imageColor[0],stroke:settings.imageColor[1]}:settings.imageColor&&(settings.imageColor={fill:settings.imageColor});var element=_CreateElement(overlay,settings.imageOrder,settings.imageAutoResize,settings.imageResizeFactor,settings.imageAnimation);"<svg"===settings.image.slice(0,4).toLowerCase()&&"</svg>"===settings.image.slice(-6).toLowerCase()?(element.append(settings.image),element.children().css(_css.element_svg),!settings.imageClass&&settings.imageColor&&element.find("*").css(settings.imageColor)):".svg"===settings.image.slice(-4).toLowerCase()||"data:image/svg"===settings.image.slice(0,14).toLowerCase()?element.load(settings.image,function(){element.children().css(_css.element_svg),!settings.imageClass&&settings.imageColor&&element.find("*").css(settings.imageColor)}):element.css({"background-image":"url("+settings.image+")","background-position":"center","background-repeat":"no-repeat","background-size":"cover"}),settings.imageClass&&element.addClass(settings.imageClass)}if(settings.fontawesome){var element=_CreateElement(overlay,settings.fontawesomeOrder,settings.fontawesomeAutoResize,settings.fontawesomeResizeFactor,settings.fontawesomeAnimation).addClass("loadingoverlay_fa");$("<div>",{class:settings.fontawesome}).appendTo(element),settings.fontawesomeColor&&element.css("color",settings.fontawesomeColor)}if(settings.custom)var element=_CreateElement(overlay,settings.customOrder,settings.customAutoResize,settings.customResizeFactor,settings.customAnimation).append(settings.custom);if(settings.text&&(data.text=_CreateElement(overlay,settings.textOrder,settings.textAutoResize,settings.textResizeFactor,settings.textAnimation).addClass("loadingoverlay_text").text(settings.text),settings.textClass?data.text.addClass(settings.textClass):settings.textColor&&data.text.css("color",settings.textColor)),settings.progress){var element=_CreateElement(overlay,settings.progressOrder,settings.progressAutoResize,settings.progressResizeFactor,!1).addClass("loadingoverlay_progress"),wrapper=$("<div>").css(_css.progress_wrapper).appendTo(element);data.progress={bar:$("<div>").css(_css.progress_bar).appendTo(wrapper),fixed:!1,margin:0,min:parseFloat(settings.progressMin),max:parseFloat(settings.progressMax),speed:parseInt(settings.progressSpeed,10)};var progressPositionParts=(settings.progressFixedPosition+"").replace(/\s\s+/g," ").toLowerCase().split(" ");2===progressPositionParts.length&&_ValidateProgressPosition(progressPositionParts[0])?(data.progress.fixed=progressPositionParts[0],data.progress.margin=_ParseSize(progressPositionParts[1])):2===progressPositionParts.length&&_ValidateProgressPosition(progressPositionParts[1])?(data.progress.fixed=progressPositionParts[1],data.progress.margin=_ParseSize(progressPositionParts[0])):1===progressPositionParts.length&&_ValidateProgressPosition(progressPositionParts[0])&&(data.progress.fixed=progressPositionParts[0],data.progress.margin=0),"top"===data.progress.fixed?element.css(_css.progress_fixed).css("top",data.progress.margin?data.progress.margin.value+(data.progress.margin.fixed?data.progress.margin.units:"%"):0):"bottom"===data.progress.fixed&&element.css(_css.progress_fixed).css("top","auto"),settings.progressClass?data.progress.bar.addClass(settings.progressClass):settings.progressColor&&data.progress.bar.css("background",settings.progressColor)}settings.fade?!0===settings.fade?settings.fade=_defaultValues.fade:"string"==typeof settings.fade||"number"==typeof settings.fade?settings.fade=[settings.fade,settings.fade]:$.isArray(settings.fade)&&settings.fade.length<2&&(settings.fade=[settings.fade[0],settings.fade[0]]):settings.fade=[0,0],settings.fade=[parseInt(settings.fade[0],10),parseInt(settings.fade[1],10)],data.settings=settings,overlay.data("loadingoverlay_data",data),container.data("loadingoverlay",overlay),overlay.fadeTo(0,.01).appendTo("body"),_IntervalResize(container,!0),settings.resizeInterval>0&&(data.resizeIntervalId=setInterval(function(){_IntervalResize(container,!1)},settings.resizeInterval)),overlay.fadeTo(settings.fade[0],1)}data.count++}function Hide(container,force){container=$(container);var overlay=container.data("loadingoverlay"),data=_GetData(overlay);!1!==data&&(data.count--,(force||data.count<=0)&&(data.resizeIntervalId&&clearInterval(data.resizeIntervalId),overlay.fadeOut(data.settings.fade[1],function(){$(this).remove()}),container.removeData("loadingoverlay")))}function Resize(container){_IntervalResize($(container),!0)}function Text(container,value){container=$(container);var overlay=container.data("loadingoverlay"),data=_GetData(overlay);!1!==data&&data.text&&(!1===value?data.text.hide():data.text.show().text(value))}function Progress(container,value){container=$(container);var overlay=container.data("loadingoverlay"),data=_GetData(overlay);if(!1!==data&&data.progress)if(!1===value)data.progress.bar.hide();else{var v=100*((parseFloat(value)||0)-data.progress.min)/(data.progress.max-data.progress.min);v<0&&(v=0),v>100&&(v=100),data.progress.bar.show().animate({width:v+"%"},data.progress.speed)}}function _IntervalResize(container,force){var overlay=container.data("loadingoverlay"),data=_GetData(overlay);if(!1!==data){if(!data.wholePage){var isFixed="fixed"===container.css("position"),pos=isFixed?container[0].getBoundingClientRect():container.offset();overlay.css({position:isFixed?"fixed":"absolute",top:pos.top+parseInt(container.css("border-top-width"),10),left:pos.left+parseInt(container.css("border-left-width"),10),width:container.innerWidth(),height:container.innerHeight()})}if(data.settings.size){var c=data.wholePage?$(window):container,size=data.settings.size.value;data.settings.size.fixed||(size=Math.min(c.innerWidth(),c.innerHeight())*size/100,data.settings.maxSize&&size>data.settings.maxSize&&(size=data.settings.maxSize),data.settings.minSize&&size<data.settings.minSize&&(size=data.settings.minSize)),overlay.children(".loadingoverlay_element").each(function(){var $this=$(this);if(force||$this.data("loadingoverlay_autoresize")){var resizeFactor=$this.data("loadingoverlay_resizefactor");$this.hasClass("loadingoverlay_fa")||$this.hasClass("loadingoverlay_text")?$this.css("font-size",size*resizeFactor+data.settings.size.units):$this.hasClass("loadingoverlay_progress")?(data.progress.bar.css("height",size*resizeFactor+data.settings.size.units),data.progress.fixed?"bottom"===data.progress.fixed&&$this.css("bottom",data.progress.margin?data.progress.margin.value+(data.progress.margin.fixed?data.progress.margin.units:"%"):0).css("bottom","+="+size*resizeFactor+data.settings.size.units):data.progress.bar.css("top",$this.position().top).css("top","-="+size*resizeFactor*.5+data.settings.size.units)):$this.css({width:size*resizeFactor+data.settings.size.units,height:size*resizeFactor+data.settings.size.units})}})}}}function _GetData(overlay){var data=void 0===overlay?undefined:overlay.data("loadingoverlay_data");return void 0===data?($(".loadingoverlay").each(function(){var $this=$(this);document.body.contains($this.data("loadingoverlay_data").container[0])||$this.remove()}),!1):data}function _CreateElement(overlay,order,autoResize,resizeFactor,animation){var element=$("<div>",{class:"loadingoverlay_element",css:{order:order}}).css(_css.element).data({loadingoverlay_autoresize:autoResize,loadingoverlay_resizefactor:resizeFactor}).appendTo(overlay);if(!0===animation&&(animation=_defaultValues.animations.time+" "+_defaultValues.animations.name),"string"==typeof animation){var animationName,animationTime,parts=animation.replace(/\s\s+/g," ").toLowerCase().split(" ");2===parts.length&&_ValidateCssTime(parts[0])&&_ValidateAnimation(parts[1])?(animationName=parts[1],animationTime=parts[0]):2===parts.length&&_ValidateCssTime(parts[1])&&_ValidateAnimation(parts[0])?(animationName=parts[0],animationTime=parts[1]):1===parts.length&&_ValidateCssTime(parts[0])?(animationName=_defaultValues.animations.name,animationTime=parts[0]):1===parts.length&&_ValidateAnimation(parts[0])&&(animationName=parts[0],animationTime=_defaultValues.animations.time),element.css({"animation-name":"loadingoverlay_animation__"+animationName,"animation-duration":animationTime,"animation-timing-function":"linear","animation-iteration-count":"infinite"})}return element}function _ValidateCssTime(value){return!isNaN(parseFloat(value))&&("s"===value.slice(-1)||"ms"===value.slice(-2))}function _ValidateAnimation(value){return _whitelists.animations.indexOf(value)>-1}function _ValidateProgressPosition(value){return _whitelists.progressPosition.indexOf(value)>-1}function _ParseSize(value){return!(!value||value<0)&&("string"==typeof value&&["vmin","vmax"].indexOf(value.slice(-4))>-1?{fixed:!0,units:value.slice(-4),value:value.slice(0,-4)}:"string"==typeof value&&["rem"].indexOf(value.slice(-3))>-1?{fixed:!0,units:value.slice(-3),value:value.slice(0,-3)}:"string"==typeof value&&["px","em","cm","mm","in","pt","pc","vh","vw"].indexOf(value.slice(-2))>-1?{fixed:!0,units:value.slice(-2),value:value.slice(0,-2)}:{fixed:!1,units:"px",value:parseFloat(value)})}var _defaults={background:"rgba(255, 255, 255, 0.8)",backgroundClass:"",image:"<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1000 1000'><circle r='80' cx='500' cy='90'/><circle r='80' cx='500' cy='910'/><circle r='80' cx='90' cy='500'/><circle r='80' cx='910' cy='500'/><circle r='80' cx='212' cy='212'/><circle r='80' cx='788' cy='212'/><circle r='80' cx='212' cy='788'/><circle r='80' cx='788' cy='788'/></svg>",imageAnimation:"2000ms rotate_right",imageAutoResize:!0,imageResizeFactor:1,imageColor:"#202020",imageClass:"",imageOrder:1,fontawesome:"",fontawesomeAnimation:"",fontawesomeAutoResize:!0,fontawesomeResizeFactor:1,fontawesomeColor:"#202020",fontawesomeOrder:2,custom:"",customAnimation:"",customAutoResize:!0,customResizeFactor:1,customOrder:3,text:"",textAnimation:"",textAutoResize:!0,textResizeFactor:.5,textColor:"#202020",textClass:"",textOrder:4,progress:!1,progressAutoResize:!0,progressResizeFactor:.25,progressColor:"#a0a0a0",progressClass:"",progressOrder:5,progressFixedPosition:"",progressSpeed:200,progressMin:0,progressMax:100,size:50,maxSize:120,minSize:20,direction:"column",fade:!0,resizeInterval:50,zIndex:2147483647},_css={overlay:{"box-sizing":"border-box",position:"relative",display:"flex","flex-wrap":"nowrap","align-items":"center","justify-content":"space-around"},element:{"box-sizing":"border-box",overflow:"visible",flex:"0 0 auto",display:"flex","justify-content":"center","align-items":"center"},element_svg:{width:"100%",height:"100%"},progress_fixed:{position:"absolute",left:"0",width:"100%"},progress_wrapper:{position:"absolute",top:"0",left:"0",width:"100%",height:"100%"},progress_bar:{position:"absolute",left:"0"}},_dataTemplate={count:0,container:undefined,settings:undefined,wholePage:undefined,resizeIntervalId:undefined,text:undefined,progress:undefined},_whitelists={animations:["rotate_right","rotate_left","fadein","pulse"],progressPosition:["top","bottom"]},_defaultValues={animations:{name:"rotate_right",time:"2000ms"},fade:[400,200]};$.LoadingOverlaySetup=function(settings){$.extend(!0,_defaults,settings)},$.LoadingOverlay=function(action,options){switch(action.toLowerCase()){case"show":Show("body",$.extend(!0,{},_defaults,options));break;case"hide":Hide("body",options);break;case"resize":Resize("body");break;case"text":Text("body",options);break;case"progress":Progress("body",options)}},$.fn.LoadingOverlay=function(action,options){switch(action.toLowerCase()){case"show":var settings=$.extend(!0,{},_defaults,options);return this.each(function(){Show(this,settings)});case"hide":return this.each(function(){Hide(this,options)});case"resize":return this.each(function(){Resize(this)});case"text":return this.each(function(){Text(this,options)});case"progress":return this.each(function(){Progress(this,options)})}},$(function(){$("head").append(["<style>","@-webkit-keyframes loadingoverlay_animation__rotate_right {","to {","-webkit-transform : rotate(360deg);","transform : rotate(360deg);","}","}","@keyframes loadingoverlay_animation__rotate_right {","to {","-webkit-transform : rotate(360deg);","transform : rotate(360deg);","}","}","@-webkit-keyframes loadingoverlay_animation__rotate_left {","to {","-webkit-transform : rotate(-360deg);","transform : rotate(-360deg);","}","}","@keyframes loadingoverlay_animation__rotate_left {","to {","-webkit-transform : rotate(-360deg);","transform : rotate(-360deg);","}","}","@-webkit-keyframes loadingoverlay_animation__fadein {","0% {","opacity   : 0;","-webkit-transform : scale(0.1, 0.1);","transform : scale(0.1, 0.1);","}","50% {","opacity   : 1;","}","100% {","opacity   : 0;","-webkit-transform : scale(1, 1);","transform : scale(1, 1);","}","}","@keyframes loadingoverlay_animation__fadein {","0% {","opacity   : 0;","-webkit-transform : scale(0.1, 0.1);","transform : scale(0.1, 0.1);","}","50% {","opacity   : 1;","}","100% {","opacity   : 0;","-webkit-transform : scale(1, 1);","transform : scale(1, 1);","}","}","@-webkit-keyframes loadingoverlay_animation__pulse {","0% {","-webkit-transform : scale(0, 0);","transform : scale(0, 0);","}","50% {","-webkit-transform : scale(1, 1);","transform : scale(1, 1);","}","100% {","-webkit-transform : scale(0, 0);","transform : scale(0, 0);","}","}","@keyframes loadingoverlay_animation__pulse {","0% {","-webkit-transform : scale(0, 0);","transform : scale(0, 0);","}","50% {","-webkit-transform : scale(1, 1);","transform : scale(1, 1);","}","100% {","-webkit-transform : scale(0, 0);","transform : scale(0, 0);","}","}","</style>"].join(" "))})})}]);